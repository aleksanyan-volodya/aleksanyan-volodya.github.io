...
In physics, the Pythagorean theorem relates the sides of a right triangle.

<aside>
  <p>This principle is expressed as: $a^2 + b^2 = c^2$ <a href="https://en.wikipedia.org/wiki/Pythagorean_theorem" target="_blank">(Source: Wikipedia)</a></p>
</aside>
